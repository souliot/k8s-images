...
mkdir -p eventing/cmd/jobsink/v1.15.0
touch eventing/cmd/jobsink/v1.15.0/Dockerfile
echo "FROM gcr.io/knative-releases/knative.dev/eventing/cmd/jobsink:v1.15.0" >eventing/cmd/jobsink/v1.15.0/Dockerfile
